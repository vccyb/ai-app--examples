...
URL Source: https://platform.claude.com/docs/en/agent-sdk/hooks
...
English[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fhooks)
...
Guides Control execution with hooks
...
3.   3 
Matchers filter which hooks run  If a hook has a [`matcher`](https://platform.claude.com/docs/en/agent-sdk/hooks#matchers) pattern (like `"Write|Edit"`), the SDK tests it against the event's target (for example, the tool name). Hooks without a matcher run for every event of that type. 
4.   4 
Callback functions execute  Each matching hook's [callback function](https://platform.claude.com/docs/en/agent-sdk/hooks#callback-functions) receives input about what's happening: the tool name, its arguments, the session ID, and other event-specific details. 
5.   5 
Your callback returns a decision  After performing any operations (logging, API calls, validation), your callback returns an [output object](https://platform.claude.com/docs/en/agent-sdk/hooks#outputs) that tells the agent what to do: allow the operation, block it, modify the input, or inject context into the conversation. 
...
3.   **Context:** In TypeScript, contains a `signal` property () for cancellation. In Python, this argument is reserved for future use.
...
*   [How hooks work](https://platform.claude.com/docs/en/agent-sdk/hooks#how-hooks-work)
*   [Available hooks](https://platform.claude.com/docs/en/agent-sdk/hooks#available-hooks)
*   [Configure hooks](https://platform.claude.com/docs/en/agent-sdk/hooks#configure-hooks)
*   [Matchers](https://platform.claude.com/docs/en/agent-sdk/hooks#matchers)
*   [Callback functions](https://platform.claude.com/docs/en/agent-sdk/hooks#callback-functions)
*   [Examples](https://platform.claude.com/docs/en/agent-sdk/hooks#examples)
*   [Modify tool input](https://platform.claude.com/docs/en/agent-sdk/hooks#modify-tool-input)
*   [Add context and block a tool](https://platform.claude.com/docs/en/agent-sdk/hooks#add-context-and-block-a-tool)
*   [Auto-approve specific tools](https://platform.claude.com/docs/en/agent-sdk/hooks#auto-approve-specific-tools)
*   [Chain multiple hooks](https://platform.claude.com/docs/en/agent-sdk/hooks#chain-multiple-hooks)
*   [Filter with regex matchers](https://platform.claude.com/docs/en/agent-sdk/hooks#filter-with-regex-matchers)
*   [Track subagent activity](https://platform.claude.com/docs/en/agent-sdk/hooks#track-subagent-activity)
*   [Make HTTP requests from hooks](https://platform.claude.com/docs/en/agent-sdk/hooks#make-http-requests-from-hooks)
*   [Forward notifications to Slack](https://platform.claude.com/docs/en/agent-sdk/hooks#forward-notifications-to-slack)
*   [Fix common issues](https://platform.claude.com/docs/en/agent-sdk/hooks#fix-common-issues)
*   [Hook not firing](https://platform.claude.com/docs/en/agent-sdk/hooks#hook-not-firing)
*   [Matcher not filtering as expected](https://platform.claude.com/docs/en/agent-sdk/hooks#matcher-not-filtering-as-expected)
*   [Hook timeout](https://platform.claude.com/docs/en/agent-sdk/hooks#hook-timeout)
*   [Tool blocked unexpectedly](https://platform.claude.com/docs/en/agent-sdk/hooks#tool-blocked-unexpectedly)
*   [Modified input not applied](https://platform.claude.com/docs/en/agent-sdk/hooks#modified-input-not-applied)
*   [Session hooks not available in Python](https://platform.claude.com/docs/en/agent-sdk/hooks#session-hooks-not-available-in-python)
*   [Subagent permission prompts multiplying](https://platform.claude.com/docs/en/agent-sdk/hooks#subagent-permission-prompts-multiplying)
*   [Recursive hook loops with subagents](https://platform.claude.com/docs/en/agent-sdk/hooks#recursive-hook-loops-with-subagents)
*   [systemMessage not appearing in output](https://platform.claude.com/docs/en/agent-sdk/hooks#system-message-not-appearing-in-output)
*   [Related resources](https://platform.claude.com/docs/en/agent-sdk/hooks#related-resources)
