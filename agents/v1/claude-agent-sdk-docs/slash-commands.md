...
URL Source: https://platform.claude.com/docs/en/agent-sdk/slash-commands
...
English[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fslash-commands)
...
Guides Slash Commands in the SDK
...
*   [Discovering Available Slash Commands](https://platform.claude.com/docs/en/agent-sdk/slash-commands#discovering-available-slash-commands)
*   [Sending Slash Commands](https://platform.claude.com/docs/en/agent-sdk/slash-commands#sending-slash-commands)
*   [Common Slash Commands](https://platform.claude.com/docs/en/agent-sdk/slash-commands#common-slash-commands)
*   [/compact - Compact Conversation History](https://platform.claude.com/docs/en/agent-sdk/slash-commands#compact-compact-conversation-history)
*   [/clear - Clear Conversation](https://platform.claude.com/docs/en/agent-sdk/slash-commands#clear-clear-conversation)
*   [Creating Custom Slash Commands](https://platform.claude.com/docs/en/agent-sdk/slash-commands#creating-custom-slash-commands)
*   [File Locations](https://platform.claude.com/docs/en/agent-sdk/slash-commands#file-locations)
*   [File Format](https://platform.claude.com/docs/en/agent-sdk/slash-commands#file-format)
*   [Using Custom Commands in the SDK](https://platform.claude.com/docs/en/agent-sdk/slash-commands#using-custom-commands-in-the-sdk)
*   [Advanced Features](https://platform.claude.com/docs/en/agent-sdk/slash-commands#advanced-features)
*   [Organization with Namespacing](https://platform.claude.com/docs/en/agent-sdk/slash-commands#organization-with-namespacing)
*   [Practical Examples](https://platform.claude.com/docs/en/agent-sdk/slash-commands#practical-examples)
*   [See Also](https://platform.claude.com/docs/en/agent-sdk/slash-commands#see-also)
