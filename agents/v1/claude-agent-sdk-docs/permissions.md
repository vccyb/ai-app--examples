...
URL Source: https://platform.claude.com/docs/en/agent-sdk/permissions
...
English[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fpermissions)
...
1.   1 
Hooks  Run [hooks](https://platform.claude.com/docs/en/agent-sdk/hooks) first, which can allow, deny, or continue to the next step 
2.   2 
Deny rules  Check `deny` rules (from `disallowed_tools` and [settings.json](https://code.claude.com/docs/en/settings#permission-settings)). If a deny rule matches, the tool is blocked, even in `bypassPermissions` mode. 
3.   3 
Permission mode  Apply the active [permission mode](https://platform.claude.com/docs/en/agent-sdk/permissions#permission-modes). `bypassPermissions` approves everything that reaches this step. `acceptEdits` approves file operations. Other modes fall through. 
4.   4 
Allow rules  Check `allow` rules (from `allowed_tools` and settings.json). If a rule matches, the tool is approved. 
5.   5 
canUseTool callback  If not resolved by any of the above, call your [`canUseTool` callback](https://platform.claude.com/docs/en/agent-sdk/user-input) for a decision. In `dontAsk` mode, this step is skipped and the tool is denied. 

![Image 1: Permission evaluation flow diagram](https://platform.claude.com/docs/images/agent-sdk/permissions-flow.svg)
...
*   [How permissions are evaluated](https://platform.claude.com/docs/en/agent-sdk/permissions#how-permissions-are-evaluated)
*   [Allow and deny rules](https://platform.claude.com/docs/en/agent-sdk/permissions#allow-and-deny-rules)
*   [Permission modes](https://platform.claude.com/docs/en/agent-sdk/permissions#permission-modes)
*   [Available modes](https://platform.claude.com/docs/en/agent-sdk/permissions#available-modes)
*   [Set permission mode](https://platform.claude.com/docs/en/agent-sdk/permissions#set-permission-mode)
*   [Mode details](https://platform.claude.com/docs/en/agent-sdk/permissions#mode-details)
*   [Related resources](https://platform.claude.com/docs/en/agent-sdk/permissions#related-resources)
